...
export const createProduct = async (req, res) => {
  ...
  if (!allowFileExt.includes(ext.toLowerCase())) {
  ...
  try {
    ...
    logger.error("controllers/product-controller.js:createProduct - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const getAllProduct = async (req, res) => {
  ...
  try {
    ...
    logger.error("controllers/product-controller.js:getAllProduct - " + err.message);
    return res.status(500).json({
...
export const getProductById = async (req, res) => {
  try {
    ...
    logger.error("controllers/product-controller.js:getProductById - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const getProductByCategory = async (req, res) => {
  try {
    ...
    logger.error("controllers/product-controller.js:getProductByCategory - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const updateProduct = async (req, res) => {
  ...
  let fileName = "";
  let url = "";
  if (!req.files || req.files === null || req.files === undefined || !req.files.file) {
  ...
  try {
    ...
    logger.error("controllers/product-controller.js:updateProduct - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const deleteProduct = async (req, res) => {
  ...
  try {
    ...
    logger.error("controllers/product-controller.js:deleteProduct - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const generatePdf = async (req, res) => {
  ...
  try {
    ...
    logger.error("controllers/product-controller.js:generatePdf - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const generateExcel = async (req, res) => {
  ...
  try {
    ...
    for (let i = 0; i <= counter; i++) {
      list.forEach((item) => {
        worksheet.getCell(item + 1).border = {
          top: { style: "thin" },
          left: { style: "thin" },
          bottom: { style: "thin" },
          right: { style: "thin" },
    ...
    logger.error("controllers/product-controller.js:generateExcel - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
