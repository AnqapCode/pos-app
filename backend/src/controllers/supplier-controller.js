...
export const getAllSupplier = async (req, res) => {
  ...
  try {
    ...
    logger.error("controllers/supplier-controller.js:getAllSupplier - " + err.message);
...
export const getSupplierById = async (req, res) => {
  try {
    ...
    logger.error("controllers/supplier-controller.js:getSupplierById - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const createSupplier = async (req, res) => {
  ...
  try {
    ...
    logger.error("controllers/supplier-controller.js:createSupplier - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const updateSupplier = async (req, res) => {
  ...
  try {
    ...
    logger.error("controllers/supplier-controller.js:updateSupplier - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const deleteSupplier = async (req, res) => {
  try {
    ...
    logger.error("controllers/supplier-controller.js:deleteSupplier - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const generatePdf = async (req, res) => {
  ...
  try {
    ...
    data.forEach((supplier, no) => {
      suppliers.push({
        no: no + 1,
        name: supplier.firstName + " " + (supplier.lastName ? supplier.lastName : ""),
    ...
    logger.error("controllers/supplier-controller.js:generatePdf - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
...
export const generateExcel = async (req, res) => {
  ...
  try {
    ...
    logger.error("controllers/supplier-controller.js:generateExcel - " + err.message);
    return res.status(500).json({
      message: err.message,
      result: null,
    });
